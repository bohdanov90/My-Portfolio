var data = [
	{
		...
		tags: ["RxJS", "Angular 9", "TypeScript", "Bootstrap"]
	},
	{
		id: 8,
		title: "Cocktail-DB",
	...
	},
	{
		id: 7,
		title: "StopWatch",
		description: "Minimalistic stopwatch with buttons. 'Start/Stop' - starts / stops + resets / continues timer if 'Wait' button was pressed, 'Wait' - pauses timer, works by double click. 'Reset' - resets and starts timer over.",
		linkToDemo: "https://bohdanov90.github.io/StopWatch/",
		linkToCode: "https://github.com/bohdanov90/StopWatch",
		image: "images/works-screen/stop-watch.jpg",
		tags: ["RxJS", "Angular 9", "TypeScript"]
	},
	{
		id: 6,
		title: "To-Do List",
		...
		tags: ["Angular 9", "TypeScript", "Adaptive Design"]
	},
	{
		id: 5,
